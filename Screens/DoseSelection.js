  ...
  return (
    <View style={{flex: 1}}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <Image
          source={require('../assets/images/mounjaro.jpg')}
          style={styles.image}
        />
        ...
        {dosages.map(item => (
          <TouchableOpacity
            ...
            <View style={styles.cardRow}>
              ...
              <View style={styles.rightSection}>
                ...
                <Text style={styles.balanceSub}>
                  £
                  {(Number(item.price.replace(/[\u00A3,]/g, '')) / 12).toFixed(
                    2,
                  )}
                </Text>
              </View>
            ...
            <View
              style={[
                styles.qtyRow,
                selected !== item.label && {opacity: 0.5},
              ]}>
              <TouchableOpacity
                onPress={selected === item.label ? decrease : undefined}
                style={styles.qtyBtn}>
                <Text>-</Text>
              </TouchableOpacity>
              <Text style={styles.qtyText}>
                {selected === item.label ? quantity : 1}
              </Text>
              <TouchableOpacity
                onPress={selected === item.label ? increase : undefined}
                style={styles.qtyBtn}>
                <Text>+</Text>
              </TouchableOpacity>
            </View>
      ...
      <View style={styles.footerBar}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            const price =
              Number(selectedDose?.price.replace(/[\u00A3,]/g, '')) || 0;
