...
export default function CalculateWeight() {
    ...
    const isStLbValid = unit === 'st' && (stone.trim() !== '' || pound.trim() !== '');
        ...
        <>
            ...
            <ScrollView contentContainerStyle={styles.container}>
                ...
                <Text style={styles.subText}>
                    Your Body Mass Index (BMI) is an important factor in assessing your eligibility for treatment. Please enter your weight below to allow us to calculate your BMI.
                </Text>
